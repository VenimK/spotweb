...
?>
	...
	<?php } ?>
					...
					<a class="greyButton filterManager" href="<?php echo htmlspecialchars($tplHelper->makeFilterManagerUrl(), ENT_QUOTES, 'UTF-8'); ?>" target="_blank" rel="noopener"><?php echo _('Filter manager'); ?></a>
				</fieldset>
