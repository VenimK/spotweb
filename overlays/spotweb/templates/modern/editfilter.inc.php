...
<?php } ?>
				<a class="smallGreyButton filterManager" href="<?php echo htmlspecialchars($tplHelper->makeFilterManagerUrl(), ENT_QUOTES, 'UTF-8'); ?>" target="_blank" rel="noopener"><?php echo _('Filter manager'); ?></a>
			</dd>
		</form>
	</fieldset>
<?php
