...
// Paths (now in /custom/ folder structure)
define('THEME_DIR', __DIR__ . '/../themes');  // custom/themes/
define('JS_FILE', __DIR__ . '/../js/theme-switcher.js');  // custom/js/
define('HEADER_FILE', __DIR__ . '/../../templates/we1rdo/includes/header.inc.php');  // Still need to access core template
